	...
	public function __construct() {
		...
		parent::__construct(
			...
			array(
				...
				TeamDBObject::OBJ_NAME.':'.TeamServices::GET_TEAM_BY_ID 		=> RightsMap::SA_RMASK,	// only super admin 
				TeamDBObject::OBJ_NAME.':'.TeamServices::GET_TEAM_BY_DIV 		=> RightsMap::SA_RMASK,	// only super admin 
