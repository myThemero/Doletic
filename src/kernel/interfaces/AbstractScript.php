...
//
    ...
    {
        if ($partial) {
            $this->partial_log('FATAL', $msg);
        } else {
            $this->log('FATAL', $msg);
        }
    }

    protected function endlog($msg)
    {
        echo "$msg\n";
    }
