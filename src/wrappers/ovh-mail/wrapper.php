...
class OVHMailWrapper extends AbstractOVHWrapper
{
    ...
    public function Execute($function = "", $params = array())
    {
        $r = null;
        if (false) {
        } else if (!strcmp($function, OVHMailWrapper::FUNC_LIST_DOMAINS)) {
            $r = $this->_func_available_services($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_DOMAIN_PROPERTIES)) {
            $r = $this->_func_domain_properties($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_LIST_ACCOUNTS)) {
            $r = $this->_func_list_accounts($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_ACCOUNT_PROPERTIES)) {
            $r = $this->_func_account_properties($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_LIST_FILTERS)) {
            $r = $this->_func_list_filters($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_FILTER_PROPERTIES)) {
            $r = $this->_func_filter_properties($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_LIST_RULES)) {
            $r = $this->_func_list_rules($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_RULE_PROPERTIES)) {
            $r = $this->_func_rule_properties($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_ACCOUNT_USAGE)) {
            $r = $this->_func_account_usage($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_LIST_ACL)) {
            $r = $this->_func_list_acl($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_ACL_PROPERTIES)) {
            $r = $this->_func_acl_properties($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_LIST_MXFILTERS)) {
            $r = $this->_func_list_mxfilters($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_LIST_MXRECORDS)) {
            $r = $this->_func_list_mxrecords($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_LIST_MAILLISTS)) {
            $r = $this->_func_list_maillists($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_MAILLIST_PROPERTIES)) {
            $r = $this->_func_maillist_properties($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_LIST_MODERATORS)) {
            $r = $this->_func_list_moderators($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_MODERATOR_PROPERTIES)) {
            $r = $this->_func_moderator_properties($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_LIST_SUBSCRIBERS)) {
            $r = $this->_func_list_subscribers($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_SUBSCRIBER_PROPERTIES)) {
            $r = $this->_func_subscriber_properties($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_LIST_QUOTAS)) {
            $r = $this->_func_list_quotas($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_LIST_REDIRECTIONS)) {
            $r = $this->_func_list_redirections($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_REDIRECTION_PROPERTIES)) {
            $r = $this->_func_redirection_properties($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_LIST_RESPONDERS)) {
            $r = $this->_func_list_responders($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_RESPONDER_PROPERTIES)) {
            $r = $this->_func_responder_properties($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_SERVICES_INFO)) {
            $r = $this->_func_services_info($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_SUMMARY)) {
            $r = $this->_func_summary($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_LIST_ACCOUNT_TASKS)) {
            $r = $this->_func_list_account_tasks($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_ACCOUNT_TASK_PROPERTIES)) {
            $r = $this->_func_account_task_properties($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_LIST_FILTER_TASKS)) {
            $r = $this->_func_list_filter_tasks($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_FILTER_TASK_PROPERTIES)) {
            $r = $this->_func_filter_task_properties($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_LIST_MAILLIST_TASKS)) {
            $r = $this->_func_list_maillist_tasks($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_MAILLIST_TASK_PROPERTIES)) {
            $r = $this->_func_maillist_task_properties($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_LIST_REDIRECTION_TASKS)) {
            $r = $this->_func_list_redirection_tasks($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_REDIRECTION_TASK_PROPERTIES)) {
            $r = $this->_func_redirection_task_properties($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_LIST_RESPONDER_TASKS)) {
            $r = $this->_func_list_responder_tasks($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_RESPONDER_TASK_PROPERTIES)) {
            $r = $this->_func_responder_task_properties($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_UPDATE_ACCOUNT)) {
            $r = $this->_func_update_account($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_UPDATE_MAILLIST)) {
            $r = $this->_func_update_maillist($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_UPDATE_RESPONDER)) {
            $r = $this->_func_update_responder($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_UPDATE_SERVICES_INFO)) {
            $r = $this->_func_update_services_info($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_CREATE_MAILBOX)) {
            $r = $this->_func_create_mailbox($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_CHANGE_MAILBOX_PWD)) {
            $r = $this->_func_change_mailbox_pwd($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_CREATE_FILTER)) {
            $r = $this->_func_create_filter($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_CHANGE_FILTER_ACTIVITY)) {
            $r = $this->_func_change_filter_activity($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_CHANGE_FILTER_PRIORITY)) {
            $r = $this->_func_change_filter_priority($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_CREATE_RULE)) {
            $r = $this->_func_create_rule($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_UPDATE_ACCOUNT_USAGE)) {
            $r = $this->_func_update_account_usage($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_CREATE_ACL)) {
            $r = $this->_func_create_acl($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_CHANGE_CONTACT)) {
            $r = $this->_func_change_contact($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_CHANGE_MXFILTER)) {
            $r = $this->_func_change_mxfilter($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_CREATE_MAILLIST)) {
            $r = $this->_func_create_maillist($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_CHANGE_MAILLIST_OPTS)) {
            $r = $this->_func_change_maillist_opts($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_ADD_MODERATOR)) {
            $r = $this->_func_add_moderator($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_SEND_MAILLIST_BY_MAIL)) {
            $r = $this->_func_send_maillist_by_mail($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_ADD_SUBSCRIBER)) {
            $r = $this->_func_add_subscriber($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_CREATE_DOMAIN_DELEG)) {
            $r = $this->_func_create_domain_deleg($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_CREATE_REDIRECTION)) {
            $r = $this->_func_create_redirection($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_CHANGE_REDIRECTION)) {
            $r = $this->_func_change_redirection($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_CREATE_RESPONDER)) {
            $r = $this->_func_create_responder($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_REMOVE_MAILBOX)) {
            $r = $this->_func_remove_mailbox($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_REMOVE_FILTER)) {
            $r = $this->_func_remove_filter($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_REMOVE_RULE)) {
            $r = $this->_func_remove_rule($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_REMOVE_ACL)) {
            $r = $this->_func_remove_acl($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_REMOVE_MAILLIST)) {
            $r = $this->_func_remove_maillist($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_REMOVE_MODERATOR)) {
            $r = $this->_func_remove_moderator($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_REMOVE_SUBSCRIBER)) {
            $r = $this->_func_remove_subscriber($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_REMOVE_REDIRECTION)) {
            $r = $this->_func_remove_redirection($params);
        } else if (!strcmp($function, OVHMailWrapper::FUNC_REMOVE_RESPONDER)) {
            $r = $this->_func_remove_responder($params);
        } else {
            $r = "Unknown function called.";
        }
        return $r;
    }
